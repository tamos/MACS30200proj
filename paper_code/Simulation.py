...
def go(args):
	...
	print(round(np.mean(error_list), 3))
...
if __name__ == "__main__":
	...
	rranges = (slice(0.00001,1,0.25), slice(0.001, 1, 0.25),
		slice(0.001, 100, 10), slice(0.001, 1000, 100),
		slice(0.001, 1.0, 0.25), slice(0.001, 1.0, 0.25),
	...
	#s.testing(s.training.results['vanilla_minimizer'].x)

	go([100000, 100, 20, 10, 9000, 1212, 850])
