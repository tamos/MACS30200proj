...
Where $I$ is the interaction between locations $i$ and $j$, determined by $R_i$, repelling forces at location $i$ and $A_j$, attraction at location $j$. $D_{i,j}$ is the distance between locations $i$ and $j$. [@edscott pp 21] ^[See @simini2012universal for a concise description of both the gravity and radiation models.]
...
Both gravity and radiation models are drawn from economic and demographic studies of commuting and more routine forms of migration. This leads them to rely on certain assumptions commonly found in rational choice models. [@edscott pp 20-22] These models assume an individual chooses to move from one location to another on the basis of some rational calculus - weighing the benefits and costs of staying or leaving. [@edscott pp 16] 
